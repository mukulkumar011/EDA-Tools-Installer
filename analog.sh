...
echo "=================================================="
echo " Checking /labroot/analog Directory"
echo "=================================================="

if [ ! -d "/labroot/analog" ]; then
    echo "/labroot directory not found."
    echo "Creating /labroot/analog ..."

    sudo mkdir -p /labroot/analog

    # Give ownership to current user
    sudo chown -R $USER:$USER /labroot

    echo "/labroot/analog created successfully."
else
    echo "/labroot/analog already exists."
fi
...
make
sudo make install
cd /labroot/analog/xschem-src/xschem_library
sudo git pull
